...
# 1. 配置HuggingFace镜像源（解决SSL网络问题）
# 如果网络有问题，可以设置镜像源或使用本地缓存
os.environ.setdefault("HF_ENDPOINT", "https://hf-mirror.com")  # 使用镜像源
# 或者使用本地缓存：os.environ.setdefault("TRANSFORMERS_CACHE", "./models/cache")
...
try:
    ...
    print(f"模型加载失败: {e}")
    print("提示：如果网络有问题，可以：")
    print("1. 使用镜像源：设置环境变量 HF_ENDPOINT=https://hf-mirror.com")
